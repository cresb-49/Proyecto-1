...
public class RegistrarProductoJDialog extends javax.swing.JDialog {
     ...
     * @param Connection
     */
    public RegistrarProductoJDialog(java.awt.Frame parent, boolean modal,Connection conexionBaseDatos) {
        super(parent, modal);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            precio = Double.parseDouble(this.jFormattedTextFieldPrecio.getText());
